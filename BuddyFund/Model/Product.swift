...
let productSamples = [ //이제 이곳에는 굳이 추가하지 않아도 됨. json에 추가하면 됨.
    ...
    Product(pid: "sample2", title : "애플워치 원해요! 원해요!", username : "문정원", profileImage : "user2", itemImage : "applewatch", bday : "1111", description : "펀딩설명나는정원", price: 300000, currentCollection: 9000, isFavorite: true, account: "카카오 3333-00-0000-000", createrId: "문정원"),
